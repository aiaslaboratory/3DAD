...
class Point_M2AE(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.rec_head = nn.Conv1d(self.decoder_dims[-1], 24, 1)
        # loss
    ...
    def forward(self, pts, eval=False, **kwargs):
        ...
        return loss,original_points,gt_points,rec_points,target_layer_points,center_points,mas_points,absolute_rec_points,dismas_points,all_features
        #return x_full
